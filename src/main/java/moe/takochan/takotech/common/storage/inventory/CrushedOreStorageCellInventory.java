 ...
 * 粉碎矿石存储元件库存管理。
 */
public class CrushedOreStorageCellInventory implements ITakoCellInventory {
    ...
    // 原件类型实例
    private final ItemCrushedOreStorageCell cellType;
     ...
     */
    public CrushedOreStorageCellInventory(ItemStack cellItem, ISaveProvider container) throws AppEngException {
        if (cellItem == null) {
        ...
        // 获取元件实例
        this.cellType = (ItemCrushedOreStorageCell) this.cellItem.getItem();
